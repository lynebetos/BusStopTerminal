...
public:
	...
	bool    IsPlayOver() {return m_bOver;};
...
private:
	...
	static  double m_dbVideoPTS;		//保存视频的长度；
...
//    size_t           m_nHeight;             // 分辨率的高
	...
	STC_AudioCallback* m_pstcAudioCallback;
...
void    DisplayPicture(SDL_Rect& rcDisplay, SDL_Overlay *psdlBmp);  // iWidth、iHeight为分辨率
