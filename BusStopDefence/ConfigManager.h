...
public:   //get
	...
	string GetSoftUpdateUrl() {return m_strSotfUrl;};
...
public:   //set
	void SetTemplateVersion(string strVersion){m_strTempVer = strVersion;}
	void SetAppVer(string strVer) {m_strAppVer= strVer; }
